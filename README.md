...
14. Pressing the Space key thrice makes the player character float slowly.
...
15. Holding down the Space key makes the player character jump higher.
...
- The player character should climb over any ledge when the ray cast detects a ledge, as required by the mechanic in the prompt.
...
- The player character should jump above any ledge when pressing the Space key during the ledge climb, as required by the prompt.
...
<br>
Godot - https://feather.openai.com/tasks/fa76dc0f-dfc9-47fd-8763-c71a335f2b59 - Working on the rubric items, final prompt, and screenshots for my third Godot task by following another YouTube video tutorial by IcyEngine.
